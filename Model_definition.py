...
class node_centre_encoder(nn.Module):
    ...
    def __init__(self):
        super().__init__()
        self.attn1 = NN.attention_mech(6, 6, 16)
...
class SOAP_pred_head_nenv(nn.Module):
    ...
    def __init__(self):
        super().__init__()
        self.attn1 = NN.attention_mech(70, 70, 32)
        self.attn2 = NN.attention_mech(38, 38, 16)
...
class SOAP_pred_head(nn.Module):
    ...
    def __init__(self):
        super().__init__()
        self.attn1 = NN.attention_mech(70, 134, 64)
        self.attn2 = NN.attention_mech(70, 70, 32)
        self.attn3 = NN.attention_mech(38, 38, 16)
        self.aggr = NN.aggregator(16, 16)
    ...
    def forward(self, input_graph_enc, input_node_centre_enc, input_SOAP_pred, chem_env_list_n,
        ...
        if bool(len(new_env_list)):
            ...
            for env in new_env_list:
                ...
                nodes_L_nce = Ul.class_nce_combination(nodes_L, nc_enc, 70)
                nodes_H_nce = Ul.class_nce_combination(nodes_H, nc_enc, 70)
        ...
        for env, num_env in zip(chem_env_list_n_1, range(len(chem_env_list_n_1))):
            ...
            nodes_L_env = Ul.class_env_combination(nodes_L, graph_enc, num_env, 134)
            nodes_H_env = Ul.class_env_combination(nodes_H, graph_enc, num_env, 134)
